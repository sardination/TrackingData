...
frames_tb, match_tb, team1_players, team0_players = tracab.read_tracab_match_data('EPL',fpath,fname,verbose=True)# frames is a list of the individual match snapshots (positions, velocities)
